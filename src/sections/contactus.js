            ...
            <div className="absolute w-14 h-14  ml-6 mt-3  lg:w-20  lg:h-20 bg-pink-400 opacity-90 rounded-full -mt-50"></div>
                ...
                <div className="absolute lg:hidden w-32 h-32 mr-56 mb-48 -z-40 lg:w-48 lg:h-48 bg-teal-100 rounded-full " ></div>
                        ...
                        <div className=" flex relative flex-col justify-center items-center">
                            ...
                            <h1 className="lg:text-5xl text-4xl font-medium">Get a qoutation</h1>
                            </div>
                            <div className=" form relative py-7  px-12 shadow-2xl rounded-3xl">
                                <form  className="flex  relative flex-col" >
                                    ...
                                    <input onChange={(e)=>setUserName(e.target.value)} required className="rounded-xl mb-5 border outline-none h-12 p-4 bg-gray-100 w-64"  placeholder="Rahul" type="text" />
                                    <h1 className="mb-3 text-lg font-medium">Email</h1>
                                    <input onChange={(e)=>setMailId(e.target.value)} required className="rounded-xl mb-5 border outline-none h-12 p-4 bg-gray-100 w-64" placeholder="Rahul@gmail.com" type="email" />
                                    <h1 className="mb-3 text-lg font-medium">Phone</h1>
                                    <input onChange={(e)=>setValue(e.target.value)} required className="rounded-xl mb-5 border outline-none h-12 p-4 bg-gray-100 w-64" placeholder="9876543210" type="phonenumber" />
                                </form>
                                <a className="outline-none" href="mailto:reveldorsoftwares@gmail.com"><div className="mx-auto cursor-pointer shadow-sm hover:bg-cyan-500  transition-all duration-300 bg-cyan-600 mt-3 mb-2 text-white font-medium text-lg flex justify-center items-center rounded-xl w-full h-12 py-2 outline-none">Get a Quote</div></a>
